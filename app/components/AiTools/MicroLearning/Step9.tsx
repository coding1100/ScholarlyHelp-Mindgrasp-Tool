...
export default function Step9({
    ...
    return (
        <div className="h-[calc(100vh-8vh)] overflow-y-auto flex justify-center py-4  mb-6 bg-linear-to-br from-gray-100 to-gray-200">
            <div className="max-w-4xl mx-auto p-4 md:p-8">
                ...
                <div className="bg-[#F0F0F0] rounded-2xl p-4 mb-6 flex items-center justify-between shadow-lg">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[#333333] font-semibold text-lg">{topic}</span>
                    </div>
                    <button
                ...
                {/* Main Content Card */}
                <div className="bg-[#F0F0F0] rounded-3xl p-8 shadow-2xl">
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center py-20">
                            ...
                            <p className="text-[#666666] text-lg">Generating your lesson...</p>
                        </div>
                    ) : error ? (
                        <div className="flex flex-col items-center justify-center py-20">
                            ...
                            <p className="text-[#666666] text-center mb-6 max-w-md">{error}</p>
                            <button
                                onClick={fetchLesson}
                        ...
                        <div className="prose prose-lg max-w-none">
                            <ReactMarkdown
                                components={{
                                    ...
                                    hr: () => (
                                        <hr className="my-6 border-t-2 border-[#D7D7D7]" />
                                    ),
                                    blockquote: ({ children }) => (
                    ...
                    {!isLoading && !error && (
                        <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
                            <button
                                ...
                                className="px-8 py-2 rounded-lg bg-blue-500 hover:bg-blue-600 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-semibold text-sm transition-all duration-200 shadow-lg hover:shadow-xl active:scale-[0.98] cursor-pointer"
                            >
