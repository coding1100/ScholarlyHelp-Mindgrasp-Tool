            ...
            <div className="w-full max-w-2xl">
                ...
                <div className="bg-[#F0F0F0] rounded-3xl p-8 md:p-12 shadow-2xl">
                        ...
                        <div className="relative w-40 h-40">
                            ...
                            <svg className="w-40 h-40 transform -rotate-90">
                                ...
                                <circle
                                    ...
                                    className={`transition-all duration-500 ${scorePercentage >= 80
                                        ? "text-green-500"
                                        : scorePercentage >= 60
                                            ? "text-yellow-500"
                                            : "text-red-500"
                    ...
                    <div className="flex justify-center">
                        <button
                            onClick={onStartOver}
                            className="px-8 py-3 rounded-lg bg-blue-500 hover:bg-blue-600 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-semibold text-sm transition-all duration-200 shadow-lg hover:shadow-xl active:scale-[0.98] cursor-pointer"
                        >
                            Start Over
                        </button>
                    </div>
