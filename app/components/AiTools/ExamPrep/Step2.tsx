...
function parseScheduleMarkdown(markdown: string, examDate: string): ParsedSchedule {
    ...
    const examDateMatch = markdown.match(/\*\*February 1st, 2026\*\*|February 1st, 2026|2026-02-01/);
    if (examDateMatch) {
    ...
    cleanedMessage = cleanedMessage.replace(/^Creating a study plan.*?\.\s*/i, '');
...
export default function Step2({ examDate, apiResponse, examType, subject, knowledgeLevel, onBack, onStartPractice, isLoading = false }: Step2Props) {
                ...
                <div className="border border-white/20 rounded-3xl p-8 md:p-12 shadow-2xl">
                    ...
                    <div className="text-center mb-8">
                        <div className="flex items-center justify-center gap-2">
                            ...
                            <HiCalendar className="text-2xl text-blue-400" />
                        </div>
                        <p className="text-gray-400 text-sm mt-2">
                            Your personalized study plan leading up to your exam.
                        </p>
                        <p className="text-2xl font-bold text-blue-400 mt-4 border-b-2 border-teal-400 pb-2 inline-block">
                    ...
                    <div className="mb-8">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <p className="text-xl md:text-2xl font-bold text-black">Schedule Overview</p>
                        </div>
                    ...
                    <div className="mb-8">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="w-1 h-8 bg-teal-400 rounded"></div>
                            <h3 className="text-xl md:text-2xl font-bold text-black">Study Plan</h3>
                        </div>
                        <div className="ml-4 text-black">
                            <ReactMarkdown
                                components={{
                                    ...
                                    h4: ({ children }) => (
                                        <h4 className="text-lg font-bold text-blue-400 mb-3 mt-4">
                                            {children}
                                        </h4>
                                    ),
                                    p: ({ children }) => (
