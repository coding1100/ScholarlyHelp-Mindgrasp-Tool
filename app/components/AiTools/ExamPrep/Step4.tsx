...
import { HiAcademicCap, HiChartBar, HiArrowLeft, HiMagnifyingGlass } from "react-icons/hi2";
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6">
                            <div className="flex items-center justify-between mb-4">
                                {/* <HiTarget className="text-3xl text-blue-400" /> */}
                            </div>
                        ...
                        {/* <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6">
                            <div className="flex items-center justify-between mb-4">
                                <HiTrophy className="text-3xl text-blue-400" />
                            </div>
                            <div className="text-4xl font-bold text-blue-400 mb-2">
                                {bestScore}%
                            </div>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="space-y-3">
                            <div className="backdrop-blur-xl bg-gray-100 border border-gray-500 rounded-xl p-4 flex items-center justify-between">
                                ...
                                <div className={`text-xl font-bold ${examResults.score < 50
                                    ? "text-red-400"
