            ...
            <div className="w-full max-w-4xl my-8">
                        ...
                        >
                            ...
                            <div className="space-y-1">
                                {q.options.map((option) => {
                                    const isSelected = selectedAnswers.get(q.number) === option.letter;
                                    return (
                                        <label
                                            key={option.letter}
                                            className={`flex items-start gap-3 p-4 rounded-xl cursor-pointer transition-all ${isSelected
                                        ...
                                        >
                                            <input
                                                ...
                                                value={option.letter}
                                                checked={isSelected}
                                                onChange={() => handleAnswerChange(q.number, option.letter)}
                ...
                <div className="mt-8 flex justify-center">
                    <button
                        ...
                        disabled={isTimeUp}
                        className="px-8 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold text-base shadow-lg hover:shadow-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        Submit Exam
                    </button>
                </div>
                    ...
                    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
                        <div className="bg-gray-900 border border-white/20 rounded-2xl p-8 max-w-md mx-4 backdrop-blur-xl">
                            <div className="text-center">
                                <HiClock className="text-5xl text-blue-400 mx-auto mb-4" />
