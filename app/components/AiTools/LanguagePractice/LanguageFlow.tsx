...
import { useLanguagePractice, LanguagePracticeProvider } from "@/app/context/LanguagePracticeContext";
...
const STEPS: StepMeta[] = [
    { step: 1, title: "Select Language", subtitle: "Pick what you want to master" },
    ...
    { step: 5, title: "Grammar", subtitle: "Rules that make your sentences click" },
    { step: 6, title: "Conversation", subtitle: "Real-life practice, chat-style" },
    { step: 7, title: "Pronunciation", subtitle: "Sound more natural (text-based)" },
...
function Shell() {
    ...
    const canAccess = (s: number) => {
        ...
        if (s <= 3) return true;
        return onboardingComplete && Boolean(language) && Boolean(level) && goals.length > 0;
    };
