...
export default function ReviewRatings() {
  ...
  const platforms = ratings?.platforms && Array.isArray(ratings.platforms) && ratings.platforms.length > 0
      ...
      {ratings?.mainHeading && (
        <div className="text-center mb-4">
          ...
          {ratings.trustpilotRating && (
            <p className="text-sm text-gray-600">{ratings.trustpilotRating}</p>
          )}
        </div>
      )}
      <div
