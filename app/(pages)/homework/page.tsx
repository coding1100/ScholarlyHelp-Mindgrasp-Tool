  ...
  try {
    ...
    if (databaseUrl) {
      ...
      if (pageData) {
        ...
        const metaDescription = pageData.meta?.description || MetaData.homeWork.description;
        const canonicalUrl = pageData.meta?.canonicalUrl || `${baseUrl}${MetaData.homeWork.url}`;
