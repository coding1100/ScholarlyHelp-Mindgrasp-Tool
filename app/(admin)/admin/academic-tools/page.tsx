        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div>
              ...
              {(pageData.academicTools?.tools || []).map((tool: any, index: number) => (
                <div key={index} className="mb-4 p-4 border border-gray-200 rounded-md">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <button
                      type="button"
                      onClick={() => removeArrayItem('academicTools.tools', index)}
              ...
              <button
                type="button"
                onClick={() => addArrayItem('academicTools.tools', { title: '', description: '', list: [], text: '', btnText: '' })}
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div>
              ...
              {(pageData.whyTools?.qualities || []).map((quality: any, index: number) => (
                <div key={index} className="mb-4 p-4 border border-gray-200 rounded-md">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <button
                      type="button"
                      onClick={() => removeArrayItem('whyTools.qualities', index)}
                      className="text-red-600 hover:text-red-800 text-sm"
                    >
                      Remove
                    </button>
              ...
              <button
                type="button"
                onClick={() => addArrayItem('whyTools.qualities', { title: '', description: '' })}
                className="mt-2 px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300"
              >
                + Add Quality
              </button>
